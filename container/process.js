 ...
 * Date: 22/09/23
 * Description:  Process Gcode File to calculate filament,print time and weight
 * 
 * 
 */
...
export const loadFile =  function(reader,material){
                  
   gCodeOptions.filamentType = material; 
   ...
   speedsByLayer = {extrude: {}, retract: {}, move: {}};
             ...
             return {printTime:printTime,totalFilament:totalFilament,totalWeight:totalWeight ,gCodeOptions:gCodeOptions}
  ...
  //        self.postMessage('LayerCnt: ' + layerCnt);
      ...
      var sendAnalyzeDone = function(){
       // console.log(printTime,totalFilament,totalWeight,gCodeOptions)
      /*  console.log({
            "cmd": "analyzeDone",
            "msg": {
                max: max,
